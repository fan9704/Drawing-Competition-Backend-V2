...
from src.ws_router.statistic import router as ws_statistic_router
...
ws_statistic_router = TypedAPIRouter(router=ws_statistic_router, prefix="/api/ws/statistic", tags=["statistic/ws"])